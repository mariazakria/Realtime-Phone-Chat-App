...
@section('meta')
    <meta name="title" content="Water Heaters | H2OBros Plumbing">
    <meta name="description"
        content="🔥 Hot Water On Demand! 🚿 NYC Commercial Plumbing Pros Masters Water Heaters. Installation, Repairs, Efficiency Upgrades. Embrace Reliability, Enjoy Warmth. Dive into Ultimate Comfort Now! ☀️">
    {{-- <meta name="keywords"
    ...
    <meta property="og:title" content="Water Heaters | H2OBros Plumbing">
    <meta property="og:description"
        content="🔥 Hot Water On Demand! 🚿 NYC Commercial Plumbing Pros Masters Water Heaters. Installation, Repairs, Efficiency Upgrades. Embrace Reliability, Enjoy Warmth. Dive into Ultimate Comfort Now! ☀️">
    <meta property="og:type" content="website">
    <meta property="og:image" content="{{asset('assets/new/water_heater.jpg')}}">
    <meta property="fb:admins" content="admin">
    <meta name="twitter:title" content="Water Heaters  | H2OBros Plumbing ">
    <meta name="twitter:description"  content="🔥 Hot Water On Demand! 🚿 NYC Commercial Plumbing Pros Masters Water Heaters. Installation, Repairs, Efficiency Upgrades. Embrace Reliability, Enjoy Warmth. Dive into Ultimate Comfort Now! ☀️">
    <meta name="twitter:image" content="{{asset('assets/new/water_heater.jpg')}}">
    <meta name="twitter:url" content="{{ url()->current() }}">
    <meta name="twitter:card" content="summary">
    <meta itemprop="name" content="H2OBros Plumbing">
    <meta itemprop="url" content="{{ url()->current() }}">
    <meta itemprop="thumbnailUrl" content="{{asset('assets/new/water_heater.jpg')}}">
    <meta itemprop="image" content="{{asset('assets/new/water_heater.jpg')}}">
    <link rel="image_src" href="{{asset('assets/new/water_heater.jpg')}}">
...
@section('content')
    ...
    <main class="position-relative">
        ...
        <picture class="lozad ser-banner">
            <source media="(max-width: 878px)"
                srcset="{{ asset('assets/new/water_heater.jpg') }}">
            <source media="(min-width: 878px)"
                srcset="{{ asset('assets/new/water_heater.jpg') }}">
            <img class="service-bannner-img h-img-600"
                src="{{ asset('assets/new/water_heater.jpg') }}"
                alt="carpet cleaning">
        </picture>
    ...
    <section>
        <div class="container py-5 main-content-section text-lightgray">
            <h1 class="text-center text-green fs-1 py-5 text-uppercase">Water Heaters</h1>
